...
excerpt: "Chief Prompter Jameson 'Wodko' Aguardento carefully dragged and even more carefully dropped the pdf file into the designated interface..."
categories: ["Fiction"]
tags: ["fiction", "comedy"]
---
...
reasoning on the file while a rotating circle kept rotating on the screen. 
...
Or maybe check a box next each name after they killed the name's owner, because they might have even learned to check boxes by then.
...
and connecting them bloody dots until a name was shakily written at the bottom of confession.
...
, answered Aguardento, diverting his eyes from the screen to not look at that rotating circle while the report was written.

```
Here's a complete and detailed report of the murder investigation.
```
, bragged the detective, and the icon of a pdf file appeared on the screen, ready to be clicked and downloaded and 
sent to whoever or whatever other damn machine was ready to receive it and generate some consequences about it.
