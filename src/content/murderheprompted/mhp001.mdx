...
reasoning on the file containing the report from the crime scene while a rotating circle kept rotating on the screen. 
...
Accurate my ass, thought Aguardento. 
