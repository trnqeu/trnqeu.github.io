...
Accurate my ass, thought Aguardento, but again he didn't type it. He downloaded the report instead, didn't read it, 
sent it to whatever other damn machine was eager to receive it and generate some consequences about it.
